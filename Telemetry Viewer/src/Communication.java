...
public class Communication {
	...
	final static String PORT_IP   = "IP";
	...
	static {
		try { 
			...
			if(ips.length() > 0)
				localIp = ips;
			serverIp = InetAddress.getByName("10.10.10.100");
		} catch(Exception e) {}
	}
	...
	static boolean ipConnected = false;

	static int tcpUdpPort = 8919;
