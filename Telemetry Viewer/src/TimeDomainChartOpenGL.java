...
public class TimeDomainChartOpenGL extends PositionedChart {
	
	public static ChartDescriptor getDescriptor() {
		
		return new ChartDescriptor() {
			
			@Override public String toString()        { return "Time Domain Chart (OpenGL)"; }
			...
			@Override public PositionedChart createChart(int x1, int y1, int x2, int y2, int chartDuration, Dataset[] chartInputs) {
				return new TimeDomainChartOpenGL(x1, y1, x2, y2, chartDuration, chartInputs);
			}
	...
	@Override public String toString() {
		...
		return "Time Domain Chart (OpenGL)";
		
	}
	
	Animator animator;
	public TimeDomainChartOpenGL(int x1, int y1, int x2, int y2, int chartDuration, Dataset[] chartInputs) {
...
//			    gl.glHint(GL2.GL_LINE_SMOOTH_HINT, GL2.GL_DONT_CARE);
			...
			@Override public void display(GLAutoDrawable drawable) {
				...
				// draw each dataset
				RenderSlice slice = new RenderSlice(gl);
